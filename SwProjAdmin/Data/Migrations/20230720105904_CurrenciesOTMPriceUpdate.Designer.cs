...
namespace SwProjAdmin.Data.Migrations
{
    ...
    [Migration("20230720105904_CurrenciesOTMPriceUpdate")]
    partial class CurrenciesOTMPriceUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SwProjAdmin.Models.Attribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<string>("AttributeSetId")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("SwProjAdmin.Models.AttributeSet", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("SwProjAdmin.Models.Category", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("SwProjAdmin.Models.Attribute", b =>
                {
                    b.HasOne("SwProjAdmin.Models.AttributeSet", "AttributeSet")
                        .WithMany("Attributes")
            ...
            modelBuilder.Entity("SwProjAdmin.Models.Product", b =>
                {
                    b.HasOne("SwProjAdmin.Models.Category", "Category")
                        .WithMany("Products")
